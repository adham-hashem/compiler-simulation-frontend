...
const Explore: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <h2 className="text-center text-white mb-5">Explore HAMSY Compiler</h2>
        ...
        <div ref={buttonContainerRef} className="row mx-3">
          {[
            ...
            <div key={index} className="col-md-4 col-sm-6 mb-4">
              <Link
                to={item.path}
                className="explore-btn btn py-3 px-4 w-100 text-white"
                style={{ backgroundColor: "#706CEE", border: "none" }}
              >
                {item.title}
              </Link>
            </div>
